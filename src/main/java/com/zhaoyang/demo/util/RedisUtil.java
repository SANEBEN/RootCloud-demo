package com.zhaoyang.demo.util;
...
public class RedisUtil {
     ...
     * </p>
     *
     * @param key 索引键s 一个key 也可以使 string 数组
     * @return 返回删除成功的个数
     */
     ...
     * </p>
     *
     * @param key 索引键s string数组 也可以是一个key
     ...
     * </p>
     *
     * @param key 索引键s 可以使一个string 则返回set中所有的value 也可以是string数组
     * @return
     */
     ...
     * </p>
     *
     * @param key 索引键s 可以使一个string 也可以是一个string数组
     * @return
     */
